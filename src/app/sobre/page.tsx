  ...
  return (
    <div className="pt-24 pb-16">
      <div className="mx-auto max-w-3xl px-6">
        <h1 className="font-display text-4xl md:text-5xl font-normal text-text-primary page-fade-in" style={{ animationDelay: '0.1s' }}>
          Sobre
        </h1>

        <div className="mt-12 space-y-8 text-text-secondary leading-relaxed">
          <p className="text-lg page-fade-in" style={{ animationDelay: '0.2s' }}>
          ...
          <p className="page-fade-in" style={{ animationDelay: '0.3s' }}>
          ...
          <div className="border-t border-border pt-8 mt-12 page-fade-in" style={{ animationDelay: '0.4s' }}>
          ...
          <div className="border-t border-border pt-8 page-fade-in" style={{ animationDelay: '0.5s' }}>
            <h2 className="font-display text-2xl font-normal text-text-primary mb-6">
              Contacto
            </h2>
